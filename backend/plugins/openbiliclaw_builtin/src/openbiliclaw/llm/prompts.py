...
4. **必须用第二人称"你"**直接对用户讲话,不要用 "ta / 他 / 她 / 这人" 等
   ...
   - [OK] "你既要乐子也要门道,两边都不肯偏废"
   - [OK] "对世界怎么运转的好奇,在你身上是一种长期不退烧的状态"
   - [X] "ta 沉迷自走棋"(第三人称 + 具体兴趣词,双重违规)
   - [X] "这人对 AI 编程感兴趣"(第三人称 + 领域名,双重违规)
   - [X] "玩耍模式占比 50%"(规则术语不应出现在最终输出)
...
8. core_traits 用**为人特征词**(3 到 6 条),不写兴趣类别:
   - [OK] 爱玩 / 较真 / 杂食 / 信息敏感 / 自我节奏感强 / 不上纲上线 / 沉得住气 / 慢热
   - [X] 游戏玩家 / 技术钻研者 / AI 爱好者
...
def build_speculation_generation_prompt(
    *,
    ...
    system_prompt = (
        ...
        "\n"
        "[X] 反面模式（每条都违反 signal_weights 或忽略 ta 实际消费姿态）：\n"
        ...
        "而不是该领域的『学术化命题』。\n"
        "例如：\n"
        '  [OK] domain="独立咖啡馆" → specifics=["上海独立咖啡馆探店", "手冲咖啡师 vlog", "咖啡赛事剪辑"]\n'
        '  [X] domain="独立咖啡馆" → specifics=["萃取曲线分析", "烘焙度风味化学"]（过于学术）\n'
        "</specifics_rules>"
    )
