...
async def claim_task(task_id: str, agent_id: str = Query(..., description="领取任务的代理 ID")):
    """事务性领取一个待执行的任务项。"""
...
async def remove_teammate(team_id: str, agent_id: str):
    """从团队移除成员。"""
