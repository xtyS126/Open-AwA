...
# 问题反馈落盘目录：锚定到项目根 var/data/issue_reports（__file__ = backend/issue_writer/writer.py，parents[2] = 项目根）
_ISSUE_DIR = Path(__file__).resolve().parents[2] / "var" / "data" / "issue_reports"
