...
# 路径锚点（绝对路径）：
#   __file__ = lib/backend/config/settings.py
#   parents[0] = lib/backend/config/
#   parents[1] = lib/backend/
#   parents[2] = lib/
#   parents[3] = 项目根/
_BACKEND_DIR = Path(__file__).resolve().parents[1]
_PROJECT_DIR = Path(__file__).resolve().parents[3]
_VAR_DIR = _PROJECT_DIR / "var"
_DATA_DIR = _VAR_DIR / "data"
_LOG_DIR_ABS = _VAR_DIR / "logs"
_WORKSPACE_DIR = _VAR_DIR / "workspace"
_PLUGINS_DATA_DIR = _VAR_DIR / "plugins"
_PETS_DATA_DIR = _VAR_DIR / "pets"
