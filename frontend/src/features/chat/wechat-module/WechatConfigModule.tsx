          ...
          {loadingWeixin ? (
            ...
            <>
              <div className={styles['form-item']}>
                ...
                <label className={styles['label']}>{t('wechat.form.accountId')} <span className={styles['required']}>*</span></label>
                <input
                  type="text"
                  value={weixinConfig.account_id}
                  onChange={(e) => setWeixinConfig({ ...weixinConfig, account_id: e.target.value })}
                  placeholder={t('wechat.form.accountIdPlaceholder')}
                  className={styles['input']}
                />
              </div>
              <div className={styles['form-item']}>
                <label className={styles['label']}>{t('wechat.form.token')} <span className={styles['required']}>*</span></label>
                <input
                  type="password"
                  value={weixinConfig.token}
                  onChange={(e) => setWeixinConfig({ ...weixinConfig, token: e.target.value })}
                  placeholder={t('wechat.form.tokenPlaceholder')}
                  className={styles['input']}
                />
              </div>
              <div className={styles['form-item']}>
                <label className={styles['label']}>{t('wechat.form.baseUrl')}</label>
                <input
                  type="text"
                  value={weixinConfig.base_url}
                  onChange={(e) => setWeixinConfig({ ...weixinConfig, base_url: e.target.value })}
                  placeholder={t('wechat.form.baseUrlPlaceholder')}
                  className={styles['input']}
                />
              </div>
              <div className={styles['form-item']}>
                <label className={styles['label']}>{t('wechat.form.timeout')}</label>
                <input
                  type="number"
              ...
              <div className={styles['qr-login']}>
                ...
                <div className={styles['form-item']}>
                  <label className={styles['label']}>{t('wechat.form.botType')}</label>
                  <input
                    type="text"
                    value={editBotType}
                ...
                <div className={styles['form-item']}>
                  <label className={styles['label']}>{t('wechat.form.channelVersion')}</label>
                  <input
                    type="text"
                ...
                <div className={styles['form-item']} style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '12px', marginBottom: '16px' }}>
                  <input
                    type="checkbox"
                    id="autoStartReply"
                    checked={editAutoStartReply}
                    onChange={(e) => setEditAutoStartReply(e.target.checked)}
                    style={{ cursor: 'pointer' }}
                  />
                  <label htmlFor="autoStartReply" style={{ cursor: 'pointer', margin: 0, fontSize: '14px' }}>
                    在启动整个程序时自动启动自动回复
                  </label>
                </div>
                <div className={styles['actions-row']}>
