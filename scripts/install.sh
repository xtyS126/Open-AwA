...
install_backend() {
    ...
    # 安装依赖（重组后 requirements.txt 位于 backend/）
...
BACKEND_PORT=8000
DATABASE_URL=sqlite:///${INSTALL_DIR}/var/data/openawa.db
VECTOR_DB_PATH=${INSTALL_DIR}/var/data/qdrant
LOG_DIR=${INSTALL_DIR}/var/logs
EOF
